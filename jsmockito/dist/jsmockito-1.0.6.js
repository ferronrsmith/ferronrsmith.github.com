 ...
 *
 * JsMockito v1.0.6
 * http://github.com/ferronrsmith/jsmockito
 *
 * Mockito port to JavaScript
 *
 * Copyright (c) 2013 Chris Leishman, Ferron Smith
...
JsMockito.nativeTypes = {
    'Array': {
        ...
        methods: [
            ...
            'every', 'filter', 'forEach', 'indexOf', 'lastIndexOf', 'map', 'some',  // es5 additions
    ...
    'Date': {
        ...
        methods: [
            ...
            'toISOString', 'toJSON', 'now', 'parse', // es5 additions
    ...
    'String': {
        ...
        methods: [
            ...
            'toUpperCase', 'valueOf', 'trim', 'trimLeft', 'trimRight'
        ]
    },
    'RegExp': {
        type: RegExp,
...
JsMockito.Integration = {
    ...
    /**
     * Make the public JsMockito API available to Jasmine Spec Runner
     * @see JsMockito.Integration.importTo(window)
     */
    Jasmine: function () {
        JsMockito.Integration.importTo(window);
